document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        error = getRequiredMessage(field);
      } else if (value !== '') {
        if (type === 'email') {
        ...
        } else if ((type === 'text' || field.tagName === 'TEXTAREA') && field.hasAttribute('minlength')) {
          const min = parseInt(field.getAttribute('minlength'), 10);
          if (value.length < min) {
            error = 'Please enter at least ' + min + ' characters.';
          }
        }
      }

      if (field.hasAttribute('maxlength') && value.length > parseInt(field.getAttribute('maxlength'), 10)) {
        error = 'Maximum ' + field.getAttribute('maxlength') + ' characters allowed.';
      }
  ...
  function clearFormErrors(form) {
    ...
    const formMsg = form.querySelector('.form-success-message, .form-error-message');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פרסטיז' משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '04ccb1b4-319b-4a27-ab67-b7a493842a3b',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '04ccb1b4-319b-4a27-ab67-b7a493842a3b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '04ccb1b4-319b-4a27-ab67-b7a493842a3b';
